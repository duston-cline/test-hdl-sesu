...
proc create_hier_cell_angry_kitten { parentCell nameHier } {
  ...
  connect_bd_net -net S_AXI_ARESETN1_1 [get_bd_pins S_AXI_ARESETN1] [get_bd_pins axi_ak_pdw_0/S_AXI_ARESETN]
...
proc create_root_design { parentCell } {
  ...
  set f9_uart [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:uart_rtl:1.0 f9_uart ]

  set fipy_uart [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:uart_rtl:1.0 fipy_uart ]

  set fixed_io [ create_bd_intf_port -mode Master -vlnv xilinx.com:display_processing_system7:fixedio_rtl:1.0 fixed_io ]

  set iic_main [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:iic_rtl:1.0 iic_main ]

  set pltfm_uart [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:uart_rtl:1.0 pltfm_uart ]


  # Create ports
  set adc_blank_0 [ create_bd_port -dir I adc_blank_0 ]
  set enable [ create_bd_port -dir O enable ]
  set ext_ppin_vec_0 [ create_bd_port -dir I -from 7 -to 0 ext_ppin_vec_0 ]
  ...
  set new_cmd [ create_bd_port -dir O new_cmd ]
  set otg_vbusoc [ create_bd_port -dir I otg_vbusoc ]
  set ppin_0 [ create_bd_port -dir O ppin_0 ]
  set ppout_0 [ create_bd_port -dir O ppout_0 ]
  ...
  # Create instance: angry_kitten
  create_hier_cell_angry_kitten [current_bd_instance .] angry_kitten
  ...
  # Create instance: axi_f9_uart, and set properties
  set axi_f9_uart [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_uart16550:2.0 axi_f9_uart ]
  set_property -dict [ list \
   CONFIG.C_USE_MODEM_PORTS {0} \
   CONFIG.C_USE_USER_PORTS {0} \
 ] $axi_f9_uart

  # Create instance: axi_fipy_uart, and set properties
  set axi_fipy_uart [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_uart16550:2.0 axi_fipy_uart ]
  set_property -dict [ list \
   CONFIG.C_USE_MODEM_PORTS {0} \
   CONFIG.C_USE_USER_PORTS {0} \
 ] $axi_fipy_uart
  ...
  # Create instance: axi_pltfm_uart, and set properties
  set axi_pltfm_uart [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_uart16550:2.0 axi_pltfm_uart ]
  set_property -dict [ list \
   CONFIG.C_USE_MODEM_PORTS {0} \
   CONFIG.C_USE_USER_PORTS {0} \
 ] $axi_pltfm_uart
  ...
  set_property -dict [ list \
   CONFIG.PATH_TO_FILE {/home/dc179/projects/SESU/fw/projects/adrv9361z7035_ccbob_lvds/mem_init_sys.txt} \
   CONFIG.ROM_ADDR_BITS {9} \
 ] $rom_sys_0

  # Create instance: rst_sys_ps7_200M_1, and set properties
  set rst_sys_ps7_200M_1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 rst_sys_ps7_200M_1 ]
  ...
  connect_bd_intf_net -intf_net axi_cpu_interconnect_M07_AXI [get_bd_intf_pins angry_kitten/S_AXI] [get_bd_intf_pins axi_cpu_interconnect/M07_AXI]
  connect_bd_intf_net -intf_net axi_cpu_interconnect_M08_AXI [get_bd_intf_pins angry_kitten/S_AXI1] [get_bd_intf_pins axi_cpu_interconnect/M08_AXI]
  connect_bd_intf_net -intf_net axi_cpu_interconnect_M09_AXI [get_bd_intf_pins axi_cpu_interconnect/M09_AXI] [get_bd_intf_pins axi_f9_uart/S_AXI]
  connect_bd_intf_net -intf_net axi_cpu_interconnect_M10_AXI [get_bd_intf_pins axi_cpu_interconnect/M10_AXI] [get_bd_intf_pins axi_pltfm_uart/S_AXI]
  connect_bd_intf_net -intf_net axi_cpu_interconnect_M11_AXI [get_bd_intf_pins axi_cpu_interconnect/M11_AXI] [get_bd_intf_pins axi_fipy_uart/S_AXI]
  connect_bd_intf_net -intf_net axi_f9_uart_UART [get_bd_intf_ports f9_uart] [get_bd_intf_pins axi_f9_uart/UART]
  connect_bd_intf_net -intf_net axi_fipy_uart_UART [get_bd_intf_ports fipy_uart] [get_bd_intf_pins axi_fipy_uart/UART]
  ...
  connect_bd_intf_net -intf_net axi_pltfm_uart_UART [get_bd_intf_ports pltfm_uart] [get_bd_intf_pins axi_pltfm_uart/UART]
  connect_bd_intf_net -intf_net sys_ps7_DDR [get_bd_intf_ports ddr] [get_bd_intf_pins sys_ps7/DDR]
  connect_bd_intf_net -intf_net sys_ps7_FIXED_IO [get_bd_intf_ports fixed_io] [get_bd_intf_pins sys_ps7/FIXED_IO]
  connect_bd_intf_net -intf_net sys_ps7_M_AXI_GP1 [get_bd_intf_pins sys_ps7/M_AXI_GP1] [get_bd_intf_pins sys_ps7_axi_periph/S00_AXI]
  connect_bd_intf_net -intf_net sys_ps7_axi_periph_M00_AXI [get_bd_intf_pins angry_kitten/S_AXI2] [get_bd_intf_pins sys_ps7_axi_periph/M00_AXI]
  ...
  # Create port connections
  connect_bd_net -net GND_1_dout [get_bd_pins GND_1/dout] [get_bd_pins sys_concat_intc/In0] [get_bd_pins sys_concat_intc/In1] [get_bd_pins sys_concat_intc/In2] [get_bd_pins sys_concat_intc/In3] [get_bd_pins sys_concat_intc/In7] [get_bd_pins sys_concat_intc/In8] [get_bd_pins sys_concat_intc/In9] [get_bd_pins sys_concat_intc/In10] [get_bd_pins sys_concat_intc/In15] [get_bd_pins sys_ps7/ENET1_GMII_RX_CLK] [get_bd_pins sys_ps7/ENET1_GMII_TX_CLK]
  connect_bd_net -net adc_blank_0_1 [get_bd_ports adc_blank_0] [get_bd_pins angry_kitten/adc_blank]
  connect_bd_net -net angry_kitten_dac_I [get_bd_pins angry_kitten/dac_I] [get_bd_pins axi_ad9361_dac_fifo/din_data_0]
  connect_bd_net -net angry_kitten_dac_Q [get_bd_pins angry_kitten/dac_Q] [get_bd_pins axi_ad9361_dac_fifo/din_data_1]
  connect_bd_net -net angry_kitten_new_cmd [get_bd_ports new_cmd] [get_bd_pins angry_kitten/new_cmd]
  connect_bd_net -net angry_kitten_ppin_0 [get_bd_ports ppin_0] [get_bd_pins angry_kitten/ppin_0]
  connect_bd_net -net angry_kitten_ppout_0 [get_bd_ports ppout_0] [get_bd_pins angry_kitten/ppout_0]
  ...
  connect_bd_net -net axi_ad9361_adc_valid_q1 [get_bd_pins angry_kitten/adc_valid] [get_bd_pins axi_ad9361/adc_valid_q1] [get_bd_pins util_ad9361_adc_fifo/din_valid_3]
  ...
  connect_bd_net -net axi_ad9361_l_clk [get_bd_pins angry_kitten/ad9361clk] [get_bd_pins axi_ad9361/clk] [get_bd_pins axi_ad9361/l_clk] [get_bd_pins axi_ad9361_dac_fifo/dout_clk] [get_bd_pins util_ad9361_adc_fifo/din_clk] [get_bd_pins util_ad9361_divclk/clk]
  connect_bd_net -net axi_ad9361_rst [get_bd_pins angry_kitten/ad9361clk_rst] [get_bd_pins axi_ad9361/rst] [get_bd_pins axi_ad9361_dac_fifo/dout_rst] [get_bd_pins util_ad9361_adc_fifo/din_rst]
  ...
  connect_bd_net -net axi_f9_uart_ip2intc_irpt [get_bd_pins axi_f9_uart/ip2intc_irpt] [get_bd_pins sys_concat_intc/In6]
  connect_bd_net -net axi_fipy_uart_ip2intc_irpt [get_bd_pins axi_fipy_uart/ip2intc_irpt] [get_bd_pins sys_concat_intc/In4]
  ...
  connect_bd_net -net axi_pltfm_uart_ip2intc_irpt [get_bd_pins axi_pltfm_uart/ip2intc_irpt] [get_bd_pins sys_concat_intc/In5]
  ...
  connect_bd_net -net ext_ppin_vec_0_1 [get_bd_ports ext_ppin_vec_0] [get_bd_pins angry_kitten/ext_ppin_vec]
  ...
  connect_bd_net -net gps_pps_1 [get_bd_ports gps_pps] [get_bd_pins angry_kitten/gps_1pps] [get_bd_pins axi_ad9361/gps_pps]
  ...
  connect_bd_net -net rst_sys_ps7_200M_1_peripheral_aresetn [get_bd_pins angry_kitten/S_AXI_ARESETN1] [get_bd_pins rst_sys_ps7_200M_1/peripheral_aresetn] [get_bd_pins sys_ps7_axi_periph/ARESETN] [get_bd_pins sys_ps7_axi_periph/M00_ARESETN] [get_bd_pins sys_ps7_axi_periph/S00_ARESETN]
  ...
  connect_bd_net -net sys_rstgen_interconnect_aresetn [get_bd_pins axi_f9_uart/s_axi_aresetn] [get_bd_pins sys_rstgen/interconnect_aresetn]
  ...
  connect_bd_net -net util_ad9361_adc_fifo_dout_data_0 [get_bd_pins angry_kitten/adc_I] [get_bd_pins util_ad9361_adc_fifo/dout_data_0] [get_bd_pins util_ad9361_adc_pack/fifo_wr_data_0]
  connect_bd_net -net util_ad9361_adc_fifo_dout_data_1 [get_bd_pins angry_kitten/adc_Q] [get_bd_pins util_ad9361_adc_fifo/dout_data_1] [get_bd_pins util_ad9361_adc_pack/fifo_wr_data_1]
  ...
  connect_bd_net -net util_ad9361_dac_upack_fifo_rd_valid [get_bd_pins angry_kitten/dac_valid] [get_bd_pins axi_ad9361_dac_fifo/din_valid_in_0] [get_bd_pins axi_ad9361_dac_fifo/din_valid_in_1] [get_bd_pins axi_ad9361_dac_fifo/din_valid_in_2] [get_bd_pins axi_ad9361_dac_fifo/din_valid_in_3] [get_bd_pins util_ad9361_dac_upack/fifo_rd_valid]
  connect_bd_net -net util_ad9361_divclk_clk_out [get_bd_pins angry_kitten/sigclk] [get_bd_pins axi_ad9361_adc_dma/fifo_wr_clk] [get_bd_pins axi_ad9361_dac_dma/m_axis_aclk] [get_bd_pins axi_ad9361_dac_fifo/din_clk] [get_bd_pins util_ad9361_adc_fifo/dout_clk] [get_bd_pins util_ad9361_adc_pack/clk] [get_bd_pins util_ad9361_dac_upack/clk] [get_bd_pins util_ad9361_divclk/clk_out] [get_bd_pins util_ad9361_divclk_reset/slowest_sync_clk]
  connect_bd_net -net util_ad9361_divclk_reset_peripheral_aresetn [get_bd_pins angry_kitten/sigclk_nrst] [get_bd_pins axi_ad9361_dac_fifo/din_rstn] [get_bd_pins util_ad9361_adc_fifo/dout_rstn] [get_bd_pins util_ad9361_divclk_reset/peripheral_aresetn]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces sys_ps7/Data] [get_bd_addr_segs angry_kitten/axi_ak_config_rom_0/S_AXI/reg0] SEG_axi_ak_config_rom_0_reg0
  create_bd_addr_seg -range 0x00010000 -offset 0x43C10000 [get_bd_addr_spaces sys_ps7/Data] [get_bd_addr_segs angry_kitten/axi_ak_ctrl_0/S_AXI/reg0] SEG_axi_ak_ctrl_0_reg0
  create_bd_addr_seg -range 0x00010000 -offset 0x83C00000 [get_bd_addr_spaces sys_ps7/Data] [get_bd_addr_segs angry_kitten/axi_ak_pdw_0/S_AXI/reg0] SEG_axi_ak_pdw_0_reg0
  create_bd_addr_seg -range 0x00002000 -offset 0x43C20000 [get_bd_addr_spaces sys_ps7/Data] [get_bd_addr_segs axi_f9_uart/S_AXI/Reg] SEG_axi_f9_uart_Reg
  create_bd_addr_seg -range 0x00002000 -offset 0x43C22000 [get_bd_addr_spaces sys_ps7/Data] [get_bd_addr_segs axi_fipy_uart/S_AXI/Reg] SEG_axi_fipy_uart_Reg
  create_bd_addr_seg -range 0x00002000 -offset 0x43C24000 [get_bd_addr_spaces sys_ps7/Data] [get_bd_addr_segs axi_pltfm_uart/S_AXI/Reg] SEG_axi_pltfm_uart_Reg
