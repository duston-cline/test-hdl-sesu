...
--               /home/dc179/projects/SESU/fw/projects/adrv9361z7035_ccbob_lvds/adrv9361z7035_ccbob_lvds.srcs/sources_1/bd/system/ip/system_util_ad9361_adc_fifo_0/system_util_ad9361_adc_fifo_0_sim_netlist.vhdl
...
architecture STRUCTURE of system_util_ad9361_adc_fifo_0_util_wfifo is
  ...
  signal din_enable : STD_LOGIC_VECTOR ( 7 downto 0 );
  ...
  signal dout_enable_m1 : STD_LOGIC_VECTOR ( 7 downto 0 );
  ...
  attribute SOFT_HLUTNM of \din_waddr[3]_i_1\ : label is "soft_lutpair1";
  ...
  attribute ASYNC_REG of \dout_enable_m1_reg[4]\ : label is std.standard.true;
  attribute ASYNC_REG of \dout_enable_m1_reg[5]\ : label is std.standard.true;
  attribute ASYNC_REG of \dout_enable_m1_reg[6]\ : label is std.standard.true;
  attribute ASYNC_REG of \dout_enable_m1_reg[7]\ : label is std.standard.true;
  ...
  attribute SOFT_HLUTNM of dout_req_t_i_1 : label is "soft_lutpair2";
  ...
  attribute SOFT_HLUTNM of \dout_rinit[0]_i_1\ : label is "soft_lutpair2";
begin
  ...
  dout_valid_0 <= \^dout_valid_7\;
  dout_valid_1 <= \^dout_valid_7\;
  dout_valid_2 <= \^dout_valid_7\;
  dout_valid_3 <= \^dout_valid_7\;
  dout_valid_4 <= \^dout_valid_7\;
  dout_valid_5 <= \^dout_valid_7\;
  dout_valid_6 <= \^dout_valid_7\;
  dout_valid_7 <= \^dout_valid_7\;
...
\din_enable_reg[4]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\din_enable_reg[5]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\din_enable_reg[6]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\din_enable_reg[7]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\dout_enable_m1_reg[4]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
    )
        port map (
...
\dout_enable_m1_reg[5]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
    )
        port map (
...
\dout_enable_m1_reg[6]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
    )
        port map (
...
\dout_enable_m1_reg[7]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
    )
        port map (
...
\dout_enable_reg[4]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
    )
        port map (
...
\dout_enable_reg[5]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
    )
        port map (
...
\dout_enable_reg[6]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
    )
        port map (
...
\dout_enable_reg[7]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
    )
        port map (
...
entity system_util_ad9361_adc_fifo_0 is
  ...
  attribute X_CORE_INFO of system_util_ad9361_adc_fifo_0 : entity is "util_wfifo,Vivado 2019.1";
...
architecture STRUCTURE of system_util_ad9361_adc_fifo_0 is
  ...
  attribute X_INTERFACE_PARAMETER of din_clk : signal is "XIL_INTERFACENAME din_clk, ASSOCIATED_RESET din_rst, FREQ_HZ 100000000, PHASE 0.000, CLK_DOMAIN system_axi_ad9361_0_l_clk, INSERT_VIP 0";
  ...
  attribute X_INTERFACE_PARAMETER of dout_clk : signal is "XIL_INTERFACENAME dout_clk, ASSOCIATED_RESET dout_rstn, FREQ_HZ 100000000, PHASE 0.000, CLK_DOMAIN system_util_ad9361_divclk_0_clk_out, INSERT_VIP 0";
