...
#
# Generated by export_simulation on Tue Nov 10 16:46:42 -0500 2020
#
################################################################################
...
'-reset_run' switch to the './pdw_fifo.sh' script.

./pdw_fifo.sh -reset_run
...
./pdw_fifo.sh -noclean_files

For more information on the script, please type './pdw_fifo.sh -help'.
