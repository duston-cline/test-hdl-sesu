...
--               /home/dc179/projects/SESU/fw/projects/adrv9361z7035_ccbob_lvds/adrv9361z7035_ccbob_lvds.srcs/sources_1/bd/system/ip/system_axi_ad9361_dac_fifo_0/system_axi_ad9361_dac_fifo_0_sim_netlist.vhdl
...
architecture STRUCTURE of system_axi_ad9361_dac_fifo_0_util_rfifo is
  ...
  signal din_enable_m1 : STD_LOGIC_VECTOR ( 7 downto 0 );
  ...
  signal dout_enable : STD_LOGIC_VECTOR ( 7 downto 0 );
  ...
  signal \dout_raddr[4]_i_4_n_0\ : STD_LOGIC;
  signal \dout_raddr[4]_i_5_n_0\ : STD_LOGIC;
  ...
  attribute ASYNC_REG of \din_enable_m1_reg[4]\ : label is std.standard.true;
  attribute ASYNC_REG of \din_enable_m1_reg[5]\ : label is std.standard.true;
  attribute ASYNC_REG of \din_enable_m1_reg[6]\ : label is std.standard.true;
  attribute ASYNC_REG of \din_enable_m1_reg[7]\ : label is std.standard.true;
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of din_init_i_1 : label is "soft_lutpair5";
  ...
  attribute SOFT_HLUTNM of \din_req_cnt[5]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \din_req_cnt[6]_i_2\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of din_req_i_1 : label is "soft_lutpair5";
  ...
  attribute SOFT_HLUTNM of \din_waddr[0]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \din_waddr[1]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \din_waddr[2]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \din_waddr[4]_i_3\ : label is "soft_lutpair1";
  ...
  attribute SOFT_HLUTNM of dout_req_t_i_2 : label is "soft_lutpair6";
  attribute ASYNC_REG of dout_unf_m1_reg : label is std.standard.true;
begin
  din_valid_0 <= \^din_valid_7\;
  din_valid_1 <= \^din_valid_7\;
  din_valid_2 <= \^din_valid_7\;
  din_valid_3 <= \^din_valid_7\;
  din_valid_4 <= \^din_valid_7\;
  din_valid_5 <= \^din_valid_7\;
  din_valid_6 <= \^din_valid_7\;
  din_valid_7 <= \^din_valid_7\;
...
\din_enable_m1_reg[4]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
    )
        port map (
...
\din_enable_m1_reg[5]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
    )
        port map (
...
\din_enable_m1_reg[6]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
    )
        port map (
...
\din_enable_m1_reg[7]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
    )
        port map (
...
\din_enable_reg[4]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
    )
        port map (
...
\din_enable_reg[5]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
    )
        port map (
...
\din_enable_reg[6]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
    )
        port map (
...
\din_enable_reg[7]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
    )
        port map (
...
\dout_enable_reg[4]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\dout_enable_reg[5]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\dout_enable_reg[6]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\dout_enable_reg[7]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
dout_init_i_1: unisim.vcomponents.LUT5
    generic map(
      ...
      I2 => \dout_raddr[4]_i_4_n_0\,
      I3 => \dout_raddr[4]_i_5_n_0\,
...
\dout_raddr[4]_i_4\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"9009000000009009"
    )
        port map (
      ...
      I4 => dout_enable_4,
      I5 => dout_enable(4),
      O => \dout_raddr[4]_i_4_n_0\
    );
\dout_raddr[4]_i_5\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"6FF6"
    )
        port map (
...
dout_req_t_i_1: unisim.vcomponents.LUT5
    generic map(
      INIT => X"0040FFBF"
        ...
        port map (
      I0 => \dout_raddr[4]_i_5_n_0\,
      I1 => \dout_raddr[4]_i_4_n_0\,
...
\dout_valid_reg[4]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\dout_valid_reg[5]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\dout_valid_reg[6]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\dout_valid_reg[7]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
entity system_axi_ad9361_dac_fifo_0 is
  ...
  attribute X_CORE_INFO of system_axi_ad9361_dac_fifo_0 : entity is "util_rfifo,Vivado 2019.1";
...
architecture STRUCTURE of system_axi_ad9361_dac_fifo_0 is
  ...
  attribute X_INTERFACE_PARAMETER of din_clk : signal is "XIL_INTERFACENAME din_clk, ASSOCIATED_RESET din_rstn, FREQ_HZ 100000000, PHASE 0.000, CLK_DOMAIN system_util_ad9361_divclk_0_clk_out, INSERT_VIP 0";
  ...
  attribute X_INTERFACE_PARAMETER of dout_clk : signal is "XIL_INTERFACENAME dout_clk, ASSOCIATED_RESET dout_rst, FREQ_HZ 100000000, PHASE 0.000, CLK_DOMAIN system_axi_ad9361_0_l_clk, INSERT_VIP 0";
